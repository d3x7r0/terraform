...
describe("helpers", function(){
  ...
  describe('.priorityList(filename)', function(){
    ...
    it('should return all possible file names for html ordered by priority.', function(done){
      ...
      var plist = "index.jade, index.ejs, index.nunjucks, index.md, index.html.jade, index.html.ejs, index.html.nunjucks, index.html.md".split(', ')
    ...
    it('should build priority list assuming template file when unknown.', function(done){
      ...
      list.should.eql('feed.xml.jade, feed.xml.ejs, feed.xml.nunjucks, feed.xml.md'. split(', '))
      done()
    })
    ...
    it('should look for templates on json files.', function(done){
      ...
      list.should.include('profile.json.nunjucks')
      list.should.include('profile.json.md')
      list.should.eql('profile.json.jade, profile.json.ejs, profile.json.nunjucks, profile.json.md'. split(', '))
      done()
    })
    ...
    it('should look for templates when no ext present.', function(done){
      ...
      list.should.be.an.instanceOf(Array)
      list.should.have.lengthOf(4)
      list.should.eql('appcache.jade, appcache.ejs, appcache.nunjucks, appcache.md'.split(', '))
      done()
    })
